...
#---box1---
  config.vm.define :"spool-ps1" do |box1|
    ...
    box1.vm.provision "shell", path: "scripts/install-loopback-adapter.ps1", privileged: false
...
#---box2---
  config.vm.define :"spool-ps2" do |box2|
    ...
    box2.vm.provision "shell", path: "scripts/install-loopback-adapter.ps1", privileged: false
